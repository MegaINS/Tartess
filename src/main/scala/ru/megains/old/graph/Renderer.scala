...
class Renderer(tw: TartessClient) extends Logger[Renderer]{
    ...
    private def renderScene() {
        ...
        val renderChunks: Iterable[RenderChunk] = worldRenderer.renderChunks.values

        renderChunks.iterator.foreach{renderChunk =>
