...
//        // TODO:  OPTIMIZE
        ...
        if(posX != lastX ||
            ...
            for(x <- posX - Options.renderRange to posX +  Options.renderRange;
                y <- posY - Options.renderRange to posY +  Options.renderRange;
                z <- posZ - Options.renderRange to posZ +  Options.renderRange){
