...
object Frustum {
    ...
    private def cubeInFrustum(x1: Float, y1: Float, z1: Float, x2: Float, y2: Float, z2: Float): Boolean = {
    ...
    def chunkInFrustum(aabb: ChunkPosition): Boolean = cubeInFrustum(aabb.minXP / 16f, aabb.minYP / 16f, aabb.minZP / 16f, aabb.maxXP / 16f, aabb.maxYP / 16f, aabb.maxZP / 16f)
}
